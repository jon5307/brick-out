...
public class StartMouse {
  ...
  public static void main(String[] args) {
    ...
    BrickHealth brickHealth = new BrickHealth(3,7,board);
    MovingBall ball = new MovingBall(box_size / 2, box_size /2, ball_radius, box, board,brickHealth);

    BallWriter ball_writer = new BallWriter(ball);
    BoxWriter box_writer = new BoxWriter(box);
    BrickWriter brick_writer = new BrickWriter(board,brickHealth);
