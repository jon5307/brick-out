...
public class StartMouse {
  ...
  public void startGame(){
    ...
    MovingBall ball = new MMovingBall(box_size / 2, box_size / 2, ball_radius, box, board);
    ...
    MAnimationWriter writer = new MAnimationWriter(box_writer, ball_writer, brick_writer, box_size);
